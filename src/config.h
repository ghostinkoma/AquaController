...
// CPU (ESP32-C3 ダイ) 過熱アラート。概算値なのでヒステリシス付き。
constexpr float CPU_TEMP_ALERT_C = 70.0f;   // これを超えたら cpuHot=true (アラート)
constexpr float CPU_TEMP_CLEAR_C = 67.0f;   // これを下回ったら解除 (チャタリング防止)
}  // namespace safety
